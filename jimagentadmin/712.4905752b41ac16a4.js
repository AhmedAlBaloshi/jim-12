"use strict";
(self["webpackChunkJimAdmin"] = self["webpackChunkJimAdmin"] || []).push([[712],{
...
class ProductsComponent {
    ...
    getProducts() {
        // this.dummy = Array(5);
        // this.products = [];
        this.api.get('products/getAllProductsbyAgent').then((data) => {
    ...
    getStores() {
        this.stores = [];
        this.api.get('stores/getAllStoresbyAgent').then((storesRes) => {
